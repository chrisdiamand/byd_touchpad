...
void tp_init(int fd) {
    ...
    const uint8_t seq2[] = {
        ...
        0xD0, 0x00,
        0xD0, 0x04,
        0xD4, 0x01, // 0x01 = taps enabled, 0x02 = taps disabled.
        0xD5, 0x01,
        0xD7, 0x03,
        0xD8, 0x03, // 0x03 for scroll zone inertia, 0x04 to disable.
        0xDA, 0x05, // Can be 0x03 or 0x05 (or others?)
        0xDB, 0x02,
        0xE4, 0x05,
        0xD6, 0x01,
        0xDE, 0x04,
        ...
        0xCF, 0x00,
        0xD2, 0x03,
        0xE5, 0x03, // 0x04 for no inertia, 0x01 for inertia. Last bit seems to
                    // control intertia.
        0xD9, 0x02,
        0xD9, 0x07,
        0xDC, 0x03,
        ...
        0xCC, 0x00,
        0xE0, 0x00,
        0xE2, 0x01 // Needs to be 0x01 or TP won't send events.
    };
